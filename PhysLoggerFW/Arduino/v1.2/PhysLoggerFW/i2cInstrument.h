...
public:
	...
	bool SetParameter(uint8_t paramID, float value);
	bool SetParameter(uint8_t paramID, byte value);
	bool SetParameter(uint8_t paramID, uint8_t* dataBuffer, uint8_t dataType);
